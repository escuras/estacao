...
function getMetadata(type) {
    var properties = Array.from((Reflect.getMetadata(metadata_keys_1.__FIELD_CLASS_FIELDS_METADATA_KEY, type) || new Set()).values());
    return properties
        .filter(isMetadataPresentForField(type))
        .map(function (v) { return getMetadataFromField(type, v); });
}
